    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <p>Welcome to HeySeven7h!</p>

                <p>These terms and conditions outline the rules and regulations for the use of Seven7h Edu Course's
                    Website,
                    located at http://seven7h-edu.atwebpages.com/heyseven7h/enterprise.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    HeySeven7h if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing HeySeven7h, you agreed to use cookies in agreement with
                    the
                    Seven7h Edu Course's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, Seven7h Edu Course and/or its licensors own the intellectual property rights
                    for
                    all material on HeySeven7h. All intellectual property rights are reserved. You may access this from
                    HeySeven7h for your own personal use subjected to restrictions set in these terms and conditions.
                </p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from HeySeven7h</li>
                    <li>Sell, rent or sub-license material from HeySeven7h</li>
                    <li>Reproduce, duplicate or copy material from HeySeven7h</li>
                    <li>Redistribute content from HeySeven7h</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Seven7h Edu Course does not filter, edit, publish or review Comments
                    prior
                    to their presence on the website. Comments do not reflect the views and opinions of Seven7h Edu
                    Course,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                    their views and opinions. To the extent permitted by applicable laws, Seven7h Edu Course shall not
                    be
                ...
                <p>Seven7h Edu Course reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant Seven7h Edu Course a non-exclusive license to use, reproduce, edit and authorize
                    others
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    absence of Seven7h Edu Course; and (d) the link is in the context of general resource information.
                </p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Seven7h Edu Course. Please include your name,
                    your
                ...
                <p>No use of Seven7h Edu Course's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
